                ...
                <div>
                    ...
                    <div class="bg-fundo-secundario p-4 rounded-lg shadow-md space-y-4">
                        <div>
                            ...
                            <input type="text" id="config-business-name" class="w-full p-2 border border-borda rounded-md bg-fundo-input" value="${config.businessName || ''}">
                        </div>
                        <div>
                            <label for="config-nif" class="block text-sm font-medium mb-1">NIF</label>
                            <input type="text" id="config-nif" class="w-full p-2 border border-borda rounded-md bg-fundo-input" value="${config.nif || ''}">
                        </div>
                        <div>
                            <label for="config-endereco" class="block text-sm font-medium mb-1">Endereço</label>
                            <input type="text" id="config-endereco" class="w-full p-2 border border-borda rounded-md bg-fundo-input" value="${config.endereco || ''}">
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label for="config-telefone" class="block text-sm font-medium mb-1">Telefone</label>
                                <input type="tel" id="config-telefone" class="w-full p-2 border border-borda rounded-md bg-fundo-input" value="${config.telefone || ''}">
                            </div>
                            <div>
                                <label for="config-email" class="block text-sm font-medium mb-1">Email</label>
                                <input type="email" id="config-email" class="w-full p-2 border border-borda rounded-md bg-fundo-input" value="${config.email || ''}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="bg-fundo-secundario p-4 rounded-lg shadow-md">
                        <div>
                            ...
                            <select id="config-moeda" class="w-full p-2 border border-borda rounded-md bg-fundo-input">
