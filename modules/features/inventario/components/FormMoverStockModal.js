...
<div id="modal-mover-stock-overlay" class="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-[100] p-4">
    <form id="form-mover-stock" class="bg-fundo-secundario rounded-lg shadow-xl w-full max-w-sm">
        ...
        <div class="p-4">
            ...
            <p class="text-sm text-texto-secundario mb-2">Disponível no Armazém: <span>${stockArmazemTotal}</span> un.</p>
            ...
            <input type="number" id="input-mover-stock-quantidade" required min="1" max="${stockArmazemTotal}" class="w-full p-2 border border-borda rounded-md bg-fundo-principal" placeholder="Ex: 6">
        </div>
