    ...
    <form id="form-nova-despesa" class="bg-fundo-secundario rounded-lg shadow-xl w-full max-w-sm">
        ...
        <div class="p-4 space-y-4">
            <div>
                ...
                <input type="text" id="input-despesa-descricao" required class="w-full p-2 border border-borda rounded-md bg-fundo-input" placeholder="Ex: Compra de gelo">
            </div>
            <div>
                <label for="input-despesa-valor" class="block text-sm font-medium mb-1">Valor (Kz)</label>
                <input type="number" id="input-despesa-valor" required min="1" class="w-full p-2 border border-borda rounded-md bg-fundo-input">
            </div>
            <div>
                <label class="block text-sm font-medium mb-1">Método de Pagamento</label>
                <select id="select-despesa-metodo" class="w-full p-2 border border-borda rounded-md bg-fundo-input">
